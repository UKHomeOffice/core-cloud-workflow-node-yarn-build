...
## Why This Repository Contains Invalid Node
...
Any production node code must not be added to these directories, because:

* It will be invisible to SAST

* It may be mistaken for intentionally broken node

* It will not be validated by the yarn lint action
